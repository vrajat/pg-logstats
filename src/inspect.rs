...
pub fn inspect_rules() -> Vec<RuleDefinition> {
    vec![
        ...
        RuleDefinition {
            rule_id: RuleId::InspectErrors,
            emitted_action_id: RuleId::InspectErrors,
            kind: ActionKind::Errors,
            target_workflow: ActionKind::Inspect,
            target_finding_kind: None,
            destination_workflow: Some(ActionKind::Errors),
            required_identifiers: vec![],
            label: "Rank error classes from the available log window".to_string(),
            reason: "Log-backed mode is available. Use this when the incident involves query errors or database exceptions.".to_string(),
            priority: NextActionPriority::Recommended,
            risk: None,
            action_class: None,
            command_template: Some(vec![
            ...
            sql_template: None,
            required_operating_mode: Some(OperatingMode::LogBackedOnly),
            produces: vec!["workflow:errors".to_string()],
            attribution: "PostgreSQL logging configuration and error evidence prerequisites".to_string(),
        },
        RuleDefinition {
            rule_id: RuleId::InspectTempFiles,
            emitted_action_id: RuleId::InspectTempFiles,
            kind: ActionKind::TempFiles,
            target_workflow: ActionKind::Inspect,
            target_finding_kind: None,
            destination_workflow: Some(ActionKind::TempFiles),
            required_identifiers: vec![],
            label: "Rank temporary file usage from the available log window".to_string(),
            reason: "Log-backed mode is available. Use this when the incident involves disk space pressure or work_mem configuration issues.".to_string(),
            priority: NextActionPriority::Recommended,
            risk: None,
            action_class: None,
            command_template: Some(vec![
            ...
            sql_template: None,
            required_operating_mode: Some(OperatingMode::LogBackedOnly),
            produces: vec!["workflow:temp_files".to_string()],
            attribution: "PostgreSQL log_temp_files configuration and temporary file logs".to_string(),
        },
        RuleDefinition {
